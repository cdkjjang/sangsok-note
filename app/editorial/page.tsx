  ...
  return (
    <div className="space-y-6 text-[15px] leading-relaxed">
      ...
      <section className="space-y-3">
        ...
        <p>
          상속 관련 기준값은 세법 개정으로 바뀝니다. 상속세 세율과 누진공제,
          일괄공제 5억원과 배우자공제 한도, 상속등기 취득세율이 모두 개정 대상
          입니다. <strong>세율표는 오래 그대로 있다가 한 번에 바뀌기 때문에, 바뀐
          것을 놓치기 쉽습니다.</strong> 그래서 세율과 공제액 자체를 숫자로 고정하는
          검증 테스트를 따로 두어, 값이 낡으면 조용히 통과하지 않고 먼저 실패하게
          했습니다.
        </p>
        <p>
