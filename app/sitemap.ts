...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/calc/tax`, lastModified: TOOL_UPDATED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/calc/share`, lastModified: TOOL_UPDATED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/calc/deadline`, lastModified: TOOL_UPDATED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/calc/registration`, lastModified: TOOL_UPDATED, changeFrequency: "monthly", priority: 0.9 },
