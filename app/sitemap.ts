...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/calc/tax`, lastModified: CALC_UPDATED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/calc/share`, lastModified: CALC_UPDATED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/calc/deadline`, lastModified: CALC_UPDATED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/calc/registration`, lastModified: CALC_UPDATED, changeFrequency: "monthly", priority: 0.9 },
